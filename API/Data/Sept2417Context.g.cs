...
namespace Sept2417.Data
{
    /// <summary>
    /// Represents the database context for the application.
    /// </summary>
    public class Sept2417Context : DbContext
    {
        /// <summary>
        ...
        {
            optionsBuilder.UseSqlServer("Data Source=DESKTOP-7723PEB\\SQLEXPRESS;Initial Catalog=T631688_Sept2417;Persist Security Info=True;user id=sa;password=qwerty123;Integrated Security=false;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=true;");
        }
